...
public class ResolverAutoConfiguration {
    ...
    static class Resolver4SpringWebMvc {
        ...
        @Bean(name = "baseResolverMvcConfigurer")
        @ConditionalOnMissingBean(name = "baseResolverMvcConfigurer")
        WebMvcConfigurer baseResolverMvcConfigurer(@Autowired(required = false) List<JacksonNodeCustomizer> customizers) {
    ...
    static class Resolver4SpringWebFlux {
        ...
        @Bean(name = "baseResolverReactiveConfigurer")
        @ConditionalOnMissingBean(name = "baseResolverReactiveConfigurer")
        WebFluxConfigurer baseResolverReactiveConfigurer(@Autowired(required = false) List<JacksonNodeReactiveCustomizer> customizers) {
